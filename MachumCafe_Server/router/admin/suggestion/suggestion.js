...
var SuggestionClosedCafe = require('../../../model/suggestionClosedCafe')
...
router.post('/closedcafe', function(req, res) {
  var cafe = new SuggestionClosedCafe(req.body)
  cafe.cafeID = req.body.id
  cafe.save(function(err) {
    if(err) throw err
    res.json({ result: 1 })
